...
public final class JdbcSinkFactory implements SinkFactory {
    ...
    public OptionRule optionRule() {
        return JdbcOptions.sinkRule();
    }

    public SinkWriter<FluxRow> createSink(ReadonlyConfig c) {
        return new JdbcSinkWriter(c.get(JdbcOptions.URL), c.get(JdbcOptions.USERNAME), c.get(JdbcOptions.PASSWORD), c.get(JdbcOptions.TABLE), c.get(JdbcOptions.BATCH_SIZE));
    }
}
