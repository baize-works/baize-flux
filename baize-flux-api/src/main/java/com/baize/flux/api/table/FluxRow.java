...
public final class FluxRow {
    ...
    public FluxRow(RowType rowType, java.util.List<Object> values) {
        ...
        if (values == null || values.size() != rowType.fieldCount()) throw new IllegalArgumentException("values must match row type");
        this.values = java.util.Collections.unmodifiableList(new java.util.ArrayList<>(values));
    }
    public RowType rowType() { return rowType; }
    public Object getField(int index) { return values.get(index); }
    public java.util.List<Object> values() { return values; }
}
