...
Baize Flux is a local, batch-oriented data synchronization engine. It currently provides JDBC source and sink
...
`common` module. `baize-flux-framework` is the runtime module (the renamed and consolidated core/engine responsibility);
